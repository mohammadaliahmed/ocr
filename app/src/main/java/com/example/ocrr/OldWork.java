...
//                    Glide.with(com.example.ocrr.scanfinal.this).load(uri).into(image);
//
...
//                    Toast.makeText(com.example.ocrr.scanfinal.this, "NO TEXT", LENGTH_SHORT);
//                } else {
...
//                    try {
//                        responseObj.addProperty(arrayList.get(4), arrayList.get(3));
//                    } catch (Exception e) {
//
//                    }
//                    try {
...
//                    }
//                    try {
//                        responseObj.addProperty(arrayList.get(7), arrayList.get(11));
//                    } catch (Exception e) {
//
//                    }
//                    try {
//                        responseObj.addProperty(arrayList.get(8), arrayList.get(12));
//                    } catch (Exception e) {
//
//                    }
//                    try {
...
//                    }
//                    try {
//                        responseObj.addProperty(arrayList.get(42), arrayList.get(43));
//                    } catch (Exception e) {
//
//                    }
//                    try {
//                        responseObj.addProperty(arrayList.get(44), arrayList.get(45));
//                    } catch (Exception e) {
//
//                    }
//                    try {
//                        responseObj.addProperty(arrayList.get(46), arrayList.get(47));
//                    } catch (Exception e) {
//
//                    }
//
...
//            OCRAsyncTask oCRAsyncTask = new OCRAsyncTask(com.example.ocrr.scanfinal.this, mAPiKey, isOverlayRequired, url, mLanguage, mIOCRCallBack);
